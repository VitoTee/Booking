    ...
    room_data: [
      {
        ...
        roomMsg: [
          ...
          },
          {
            title: '取消政策',
            content: [
              '免费取消期限：截至入住日3天前，入住日前3天内如果取消订单，您需要支付订单全额。'
            ]
          },
          {
            title: '儿童和加床政策',
      ...
      },
      {
        ...
        roomMsg: [
          ...
          },
          {
            title: '取消政策',
            content: [
              '免费取消期限：截至入住日3天前。入住日前3天内如果取消订单，您需要支付订单全额。若未能按时入住，您需要支付订单全额。'
            ]
          },
          {
            title: '儿童和加床政策',
            content: [
              '允许客人携带儿童入住。所有额外入住的6岁至18岁的儿童，加床的收费是每人每晚TWD1000。',
              '所有额外入住的成人，加床的收费是每人每晚TWD1000。',
              '所有额外入住的6岁以下的儿童，使用现有床铺不收费。',
              '这间客房不可加床婴儿床。',
              '最多容纳：每间客房1张加床。',
            ]
          },
          ...
          },
          {
            title: '客房介绍',
            content: [
              '宽敞的套房从其大窗户可俯瞰台北101大楼和台北市景，拥有大地色调的内饰、一间起居室和一个私人保险箱。连接浴室设有浴缸和独立淋浴。'
            ]
          },
          {
            title: '设施',
      ...
      },
      {
        ...
        roomMsg: [
          ...
          },
          {
            title: '取消政策',
            content: [
              '免费取消期限：截至入住日前1天，入住日前1天内如果取消订单，您需要支付订单全额。'
            ]
          },
          {
            title: '儿童和加床政策',
            content: [
              '允许客人携带儿童入住。所有额外入住的2岁以下的儿童，加婴儿床不收费。',
              '所有额外入住的年龄较大的儿童或者成人，加床的收费是每晚WUR80。',
              '最多容纳：每间客房1张加床。'
            ]
          },
          {
